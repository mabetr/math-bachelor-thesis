...
# -> Generates and stores the datasets in dataset_dict

import numpy as np
import os
from solve_fhn_radau import solve_fhn_radau
...
def generate_dataset(T, dt, min_amp, max_amp, min_dur, max_dur, num_sim, seed):
    ...
    for i in range(num_sim):
        ...
        t, V, w = solve_fhn_radau(T, dt, current_amplitude, stim_duration)
        simulations.append({
            'id': i,
...
if __name__ == "__main__":
    ...
    # Save
    output_dir = os.path.join(os.pardir, "datasets_dict")
