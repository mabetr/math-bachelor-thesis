...
#Dataloader
data = torch.load("data_tensors_Dahlquist_scal/dataset_fno1d_minmax.pt")
...
print("New shape of the dataset:", Y_train_norm.shape)  # (batch, 1, 500)
...
# FNO1D model
modes = 32
hidden_channels = 32 # width of the FNO (i.e width of the hidden layers)
#resolution = X_train.shape[-1]

model=FNO1d(n_modes_height=modes, hidden_channels=hidden_channels, in_channels=1, out_channels=1)
model.to(device)
...
model_path = "best_fno1d_model_minmax_Dahlquist_scal.pth"
